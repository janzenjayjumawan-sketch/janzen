...
<div class="jumbotron bg-primary text-white py-5">
    <div class="container">
        <h1 class="display-4">Welcome to SocialHub</h1>
        <p class="lead">Connect, share, and discover with the world!</p>
        <?php if (!session()->get('user_id')): ?>
            <a href="<?= base_url('/auth/register') ?>" class="btn btn-light btn-lg">Get Started</a>
            <a href="<?= base_url('/auth/login') ?>" class="btn btn-outline-light btn-lg ms-2">Login</a>
        <?php else: ?>
            <a href="<?= base_url('/posts/feed') ?>" class="btn btn-light btn-lg">Go to Feed</a>
        <?php endif; ?>
    </div>
</div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 mx-auto text-center">
                <h3>Your Social Hub Awaits</h3>
                <p>Start sharing your thoughts and connecting with others!</p>
                <a href="<?= base_url('/posts/feed') ?>" class="btn btn-primary btn-lg">View Feed</a>
                <a href="<?= base_url('/posts/create') ?>" class="btn btn-success btn-lg ms-2">Create Post</a>
            </div>
        </div>
    </div>
<?php endif; ?>
